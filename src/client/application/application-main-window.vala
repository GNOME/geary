...
public class Application.MainWindow :
    ...
    private void setup_layout(Configuration config) {
        ...
        this.conversation_viewer_box.append(this.conversation_viewer);
        ...
        this.conversation_headerbar.left_actions.init(this.application.config);
        this.conversation_headerbar.right_actions.init(this.application.config);
        ...
        this.folder_conversation_actions = {
            this.conversation_headerbar.left_actions,
            this.conversation_headerbar.right_actions,
    ...
    private void select_account(Geary.Account? account) {
        if (this.selected_account != account) {
            ...
            if (account != null) {
                ...
                this.conversation_headerbar.left_actions.account = account;
                this.conversation_headerbar.right_actions.account = account;
            }
    ...
    private async void select_conversations(Gee.Collection<Geary.App.Conversation> to_select,
        ...
        this.conversation_headerbar.right_actions.selected_conversations = to_select.size;
        this.conversation_headerbar.left_actions.selected_conversations = to_select.size;
    ...
    private void update_trash_action() {
        ...
        this.conversation_headerbar.left_actions.update_trash_button(show_trash);
        this.conversation_headerbar.right_actions.update_trash_button(show_trash);
    }
    ...
    private void on_show_copy_menu() {
        if (this.is_conversation_list_shown &&
            ...
            this.conversation_headerbar.left_actions.show_copy_menu();
            this.conversation_headerbar.right_actions.show_copy_menu();
        } else {
            error_bell();
        }
    }
