...
/**
 * A widget for editing a ServiceInformation object.
 */
...
internal class Accounts.ServiceInformationWidget : Adw.PreferencesGroup {
    ...
    private void update_details() {
        ...
        this.credentials_requirement_row.visible = (service.protocol == Geary.Protocol.SMTP);
    ...
    private void update_login_name_row(Adw.EntryRow row, Geary.ServiceInformation service) {
        ...
        } else if (service.protocol == Geary.Protocol.SMTP &&
    ...
    private void update_password_row(Adw.PasswordEntryRow row, Geary.ServiceInformation service) {
        if (service.credentials != null)
