...
namespace Geary.Engine {

public const string SETTINGS_FILENAME = "geary.ini";

private bool gmime_inited = false;
private File? user_data_dir = null;
private File? resource_dir = null;

public void init(File _user_data_dir, File _resource_dir) {
...
public Geary.EngineAccount create(Geary.Credentials cred,
...
public Geary.EngineAccount open(Geary.Credentials cred) throws Error {
    return get_account(cred, new AccountInformation.from_file(get_settings_file(cred)));
}

private Geary.EngineAccount get_account(Geary.Credentials cred,
    Geary.AccountInformation account_info) throws Error {
