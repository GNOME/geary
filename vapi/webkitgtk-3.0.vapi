...
namespace WebKit {
	...
	public class DOMDocument : WebKit.DOMNode, WebKit.DOMEventTarget {
		...
		public unowned WebKit.DOMWebKitNamedFlow webkit_get_flow_by_name (string name);
	...
	[CCode (cheader_filename = "webkit/webkit.h", type_check_function = "WEBKIT_DOM_IS_ELEMENT")]
	...
	[CCode (cheader_filename = "webkit/webkit.h", type_check_function = "WEBKIT_DOM_IS_HTML_DIV_ELEMENT")]
	...
	[CCode (cheader_filename = "webkit/webkit.h", type_id="WEBKIT_DOM_HTML_ELEMENT", type_check_function="WEBKIT_DOM_IS_HTML_ELEMENT")]
	public class DOMHTMLElement : WebKit.DOMElement, WebKit.DOMEventTarget {
		...
		public unowned WebKit.DOMDOMSettableTokenList get_item_type ();
	...
	[CCode (cheader_filename = "webkit/webkit.h", type_check_function = "WEBKIT_DOM_IS_HTML_IFRAME_ELEMENT")]
	...
	[CCode (cheader_filename = "webkit/webkit.h", type_check_function = "WEBKIT_DOM_IS_HTML_TABLE_ELEMENT")]
	...
	[CCode (cheader_filename = "webkit/webkit.h")]
	public class DOMWebKitNamedFlow : WebKit.DOMObject {
		[CCode (has_construct_function = false)]
	...
	public class WebFrame : GLib.Object {
		...
		public unowned WebKit.JSGlobalContextRef get_global_context ();
